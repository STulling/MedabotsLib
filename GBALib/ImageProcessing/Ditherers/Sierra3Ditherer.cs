...
{
    internal class Sierra3Ditherer : Ditherer
    {
        ...
        private void DistributeError(float[][] errorMatrix, int x, int y, float rError, float gError, float bError)
        {
            ...
            if (x + 1 < width)
            {
                errorMatrix[y][x * 3 + 3] += rError * 5 / 32;
                errorMatrix[y][x * 3 + 4] += gError * 5 / 32;
                errorMatrix[y][x * 3 + 5] += bError * 5 / 32;
            }

            if (x + 2 < width)
            {
                errorMatrix[y][x * 3 + 6] += rError * 3 / 32;
                errorMatrix[y][x * 3 + 7] += gError * 3 / 32;
                errorMatrix[y][x * 3 + 8] += bError * 3 / 32;
            }
            ...
            if (y + 1 < height)
            {
                if (x - 2 >= 0)
                {
                    errorMatrix[y + 1][x * 3 - 6] += rError * 2 / 32;
                    errorMatrix[y + 1][x * 3 - 5] += gError * 2 / 32;
                    errorMatrix[y + 1][x * 3 - 4] += bError * 2 / 32;
                }

                if (x - 1 >= 0)
                {
                    errorMatrix[y + 1][x * 3 - 3] += rError * 4 / 32;
                    errorMatrix[y + 1][x * 3 - 2] += gError * 4 / 32;
                    errorMatrix[y + 1][x * 3 - 1] += bError * 4 / 32;
                }

                errorMatrix[y + 1][x * 3] += rError * 5 / 32;
                errorMatrix[y + 1][x * 3 + 1] += gError * 5 / 32;
                errorMatrix[y + 1][x * 3 + 2] += bError * 5 / 32;

                if (x + 1 < width)
                {
                    errorMatrix[y + 1][x * 3 + 3] += rError * 4 / 32;
                    errorMatrix[y + 1][x * 3 + 4] += gError * 4 / 32;
                    errorMatrix[y + 1][x * 3 + 5] += bError * 4 / 32;
                }

                if (x + 2 < width)
                {
                    errorMatrix[y + 1][x * 3 + 6] += rError * 2 / 32;
                    errorMatrix[y + 1][x * 3 + 7] += gError * 2 / 32;
                    errorMatrix[y + 1][x * 3 + 8] += bError * 2 / 32;
                }
            }
        }
    }
