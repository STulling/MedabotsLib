...
{
    public class LeftArmWrapper : BaseWrapper<Arm>
    {
        public LeftArmWrapper(int id, Arm data) : base(id, data)
        { }
        
        public string Name {
            get { return AllData.PartNames[id*4 + 2].Str; }
            set { AllData.PartNames[id*4 + 2].Str = value; }
        }
